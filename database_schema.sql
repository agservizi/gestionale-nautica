...
CREATE DATABASE IF NOT EXISTS gestionale_nautica CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE gestionale_nautica;
...
-- ============================================
-- TABELLA AUTH ATTEMPTS (RATE LIMIT / LOCKOUT)
-- ============================================
...
-- ============================================
-- TABELLA AUTH TOKENS (REMEMBER ME)
-- ============================================
...
-- ============================================
-- TABELLA SCHEDULED JOBS (NO CRON)
-- ============================================
...
CREATE TABLE IF NOT EXISTS clienti (
    ...
    numero_registro_iscrizione VARCHAR(50),
    data_iscrizione DATE,
    occhiali TINYINT(1) DEFAULT 0,
    documento_tipo VARCHAR(50),
    documento_data_emissione DATE,
...
CREATE TABLE IF NOT EXISTS pratiche (
    ...
    -- Campi per CONSEGUIMENTO PATENTE
    data_esame DATE,
...
-- ============================================
-- TRIGGER per aggiornare totale_pagato
-- ============================================
DELIMITER $$
...
CREATE TRIGGER after_pagamento_delete
AFTER DELETE ON pagamenti
FOR EACH ROW
BEGIN
    UPDATE pratiche 
    SET totale_pagato = (
        SELECT COALESCE(SUM(importo), 0) 
        FROM pagamenti 
        WHERE pratica_id = OLD.pratica_id
    )
    WHERE id = OLD.pratica_id;
END$$
